#!/usr/bin/env python3
"""
Figure 1G — SecA NMF Factor-3 usage on the epithelial UMAP
==========================================================
PURPOSE
    Single-panel epithelial UMAP coloured by continuous Factor_3 (Progenitor A
    / SecA) NMF usage, on the SecA gold colormap. Manuscript-ready.

INPUTS
    - fig_data_dir/meta.parquet   (UMAP1, UMAP2; epithelial cells)
    - 11d NMF usage : output_root/03_epithelial_nmf/11d_nmf_usage.csv (Factor_3)

OUTPUTS
    - figures_dir/figure1/atlas_SecA_nmf_factor_umap.{svg,png}

MANUSCRIPT PANEL(S): Fig 1G.
...
OUT_SVG = path("figures_dir", "figure1", "atlas_SecA_nmf_factor_umap.svg")
OUT_PNG = path("figures_dir", "figure1", "atlas_SecA_nmf_factor_umap.png")
...
# ---------- Config ----------
FACTOR = "Factor_3"
LABEL = "Progenitor A — SecA"
GENES = "(WT1, RCN2, PBX1)"
CMAP = LinearSegmentedColormap.from_list(
    "beige_seca_gold",
    [(0.00, "#DDD5CA"), (0.40, "#DDD5CA"), (0.55, "#E0BD78"),
     (0.70, "#D49A35"), (0.85, "#B07A1A"), (1.00, "#7A5000")], N=256,
)

...
OUTPUTS
    - figures_dir/atlas_SecA_nmf_factor_umap.{svg,png}
...
OUT_SVG = path("figures_dir", "atlas_SecA_nmf_factor_umap.svg")
OUT_PNG = path("figures_dir", "atlas_SecA_nmf_factor_umap.png")

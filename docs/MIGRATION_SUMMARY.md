...
- **scVI→scANVI integration** (CANONICAL (a) step 4): **trust boundary** — training code not in this copy; the integrated 1,980,703-cell atlas is authoritative input. Not migratable.
